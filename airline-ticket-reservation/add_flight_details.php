	...
	<body>
		...
		<form action="add_flight_details_form_handler.php" method="post">
			...
			<table cellpadding="5">
				...
				<tr>
					<td class="fix_table"><input type="text" name="flight_no" required pattern="[A-Za-z]+"></td>
				</tr>
			</table>
			<br>
			<hr>
			<table cellpadding="5">
				...
				<tr>
					<td class="fix_table"><input type="text" name="origin" required pattern="[A-Za-z]+"></td>
					<td class="fix_table"><input type="text" name="destination" required pattern="[A-Za-z]+"></td>
				</tr>
			</table>
			<br>
			<hr>
